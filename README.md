...
Integração com API Externa: Consumo via requisição HTTP para resgatar dados científicos atualizados sobre o transtorno.
...
Aloque os arquivos index.html, style.css e app.js no mesmo diretório.

Instruções de Execução
Navegue até o diretório do projeto.
Execute o arquivo index.html em um navegador web atualizado.
Abra o arquivo index.html utilizando seu navegador, ou clique com o botão direito em cima do arquivo, copie o caminho do arquivo (Copy path) e cole no navegador.
...
Abra a aplicação e verifique se o texto explicativo sobre o TEA foi carregado corretamente no topo da página (assegure-se de estar conectado à internet).
Preencha o questionário com diferentes combinações de respostas e clique no botão de ver resultado para validar se o cálculo lógico e a exibição do nível de suporte ocorrem corretamente.
